...
CREATE INDEX IF NOT EXISTS idx_sessions_proposal ON conversation_sessions(episode_proposal_id);
CREATE INDEX IF NOT EXISTS idx_sessions_created ON conversation_sessions(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_participants_session ON conversation_participants(session_id);
CREATE INDEX IF NOT EXISTS idx_participants_persona ON conversation_participants(persona_id);
CREATE INDEX IF NOT EXISTS idx_utterances_session ON conversation_utterances(session_id);
CREATE INDEX IF NOT EXISTS idx_utterances_timestamp ON conversation_utterances(session_id, timestamp_ms);
CREATE INDEX IF NOT EXISTS idx_utterances_participant ON conversation_utterances(participant_id);
CREATE INDEX IF NOT EXISTS idx_context_boards_session ON conversation_context_boards(session_id);
...
DROP TRIGGER IF EXISTS update_podcast_personas_updated_at ON podcast_personas;
...
DROP TRIGGER IF EXISTS update_context_boards_updated_at ON conversation_context_boards;
